...
public class PlayerStats {
    ...
    private PlayerGameScore.GameMode gameMode;
    ...
    public String toString() {
        return "PlayerStats{" +
                ...
                ", avgKillDeathRatio=" + avgKillDeathRatio +
                ", avgAccuracy=" + avgAccuracy +
                ", avgHeadshotAccuracy=" + avgHeadshotAccuracy +
                ", avgHealingDonePerSecond=" + avgHealingDonePerSecond +
                ", avgDamageDonePerSecond=" + avgDamageDonePerSecond +
                ", avgDamageTanked=" + avgDamageTanked +
